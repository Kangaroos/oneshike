define(['jquery', 'text!/static/tpl/article/article-tpl.hbs', 'handlebars', 'bootstrap-dialog', 'jquery.easing', 'stickUp', 'bootstrap', 'summernote', 'summernote-zh-CN'], function($, articleTpl, Handlebars, BootstrapDialog){
