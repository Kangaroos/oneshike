...
use Xyezir\EloquentOAuth\ProviderUserDetails as UserDetails;
use Xyezir\EloquentOAuth\Exceptions\ApplicationRejectedException;
use Xyezir\EloquentOAuth\Exceptions\InvalidAuthorizationCodeException;
