<?php namespace Xyezir\Datatable\Engines;

use Exception;
use Assetic\Extension\Twig\AsseticFilterFunction;
use Xyezir\Datatable\Columns\DateColumn;
use Xyezir\Datatable\Columns\FunctionColumn;
use Xyezir\Datatable\Columns\TextColumn;
...
/**
 * Class BaseEngine
 * @package Xyezir\Datatable\Engines
 */
abstract class BaseEngine {
    ...
    public function showColumns($cols)
    {
        ...
        foreach ($cols as $property) {
            ...
            {
                $this->columns->put($property, new DateColumn($property, DateColumn::DATE_TIME));
            }
            else
            {
