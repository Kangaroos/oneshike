...
use Xyezir\Datatable\Datatable;
...
class DatatableTest extends PHPUnit_Framework_TestCase {
    ...
    public function testReturnInstances()
    {
        ...
        $this->assertInstanceOf('Xyezir\Datatable\Engines\QueryEngine', $api);

        $api = $this->dt->collection(new Collection());

        $this->assertInstanceOf('Xyezir\Datatable\Engines\CollectionEngine', $api);

        $table = $this->dt->table();

        $this->assertInstanceOf('Xyezir\Datatable\Table', $table);
    }
